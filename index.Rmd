    ...
    <div class="col-md-4 project-card machine_learning">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <p class="card-text">Using a GAM answer the question: "If TTFB improves by x milliseconds, bounce rate will improve y%"</p>
 ...
 <div class="col-md-4 project-card analysis">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <p class="card-text">Evaluate performance of solar pannel power generation to identify maitainance needs and potential issues</p>
